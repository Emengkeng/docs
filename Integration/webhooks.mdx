...
[app.post](http://app.post)('/webhooks/subscriptions', (req, res) =\> {
...
def verify_signature(payload, signature, secret):
    ...
    expected = [hmac.new](http://hmac.new)(
    ...
    return [hmac.compare](http://hmac.compare)\_digest(signature, expected)
...
Use tools like [[webhook.site](http://webhook.site)](https://webhook.site) or [ngrok](https://ngrok.com) to test your webhook endpoint locally:
